...
- 1d5a78c: Add a `maxVariants` option to `expandChoon` for bounding its output
...
- 3d74e06: Add a `hiraganaToKatakana` function for converting hiragana to full-width katakana
